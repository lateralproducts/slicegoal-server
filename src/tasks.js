...
export const resolvers = {
    ...
    Query: {
        tasks: async(_, args, { req }) => {
            ...
            const starttimeTZ = startOfDayTZ({datetime, timezoneOffset: 0}) //setting to Melbourne TZ +11
            const endtimeTZ = endOfDayTZ({datetime, timezoneOffset: 0}) //setting to Melbourne TZ +11
